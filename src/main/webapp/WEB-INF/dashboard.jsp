	...
	<header>
	 ...
	 <div class="container bg-light border border-col mt-3 pt-3">
        <div class="row justify-content-center">
            <div class="col-6 mt-2 mb-2 justify-content-end border-bottom border-left border-right text-center">
    			<h4 class="other">Create a New Event:</h4>
	 ...
	 <div class="container bg-light border border-col mt-3 pt-3">
        <div class="row justify-content-center">
            <div class="col mt-2 mb-2 justify-content-end border-bottom border-left border-right text-center">
	 ...
	 <div class="container bg-light border border-col mt-3 pt-3">
        <div class="row justify-content-center">
            <div class="col mt-2 mb-2 justify-content-end border-bottom border-left border-right text-center">
    			<h4 class="other">Events in other states:</h4>
    			<table class="table table-hover">
					<thead class="thead-light">
						<tr>
					    	<th>Name</th>
